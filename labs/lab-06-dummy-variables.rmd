...
points( 2, 84, cex=2, col="steelblue" )
segments( x0=1, x1=2, y0=75, y1=84, lty=2, col="steelblue")

text( 2, 84, "b0+b1+b2", col="steelblue", pos=4 )
text( 2, 75, "b0+b1+b2+b3", col="steelblue", pos=4 )
```
