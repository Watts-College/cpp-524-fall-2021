...
This is an example where we have all of the variables we need to fit a model properly (if we use the correct model we estimate the group means very precisely), but we need to use proper specification or we will get the wrong answer because of constraints we have imposed on the data, not because of poor data or bias. 
